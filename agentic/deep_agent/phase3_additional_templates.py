# agentic/deep_agent/phase3_additional_templates.py
# =============================================================================
# SPECIFICATION TEMPLATES FOR REMAINING PRODUCT TYPES
# =============================================================================
#
# This module provides specification templates for 9 product types that were
# missing from phase3_specification_templates.py:
# - PressureTransmitterTemplate (65 specs)
# - FlowMeterTemplate (70 specs)
# - LevelTransmitterTemplate (60 specs)
# - AnalyzerTemplate (75 specs)
# - ControlValveTemplate (65 specs)
# - ThermowellTemplate (40 specs)
# - CableGlandTemplate (35 specs)
# - EnclosureTemplate (45 specs)
# - MountingKitTemplate (30 specs)
#
# Each template provides 30-75 specifications organized by category to ensure
# 60+ specs per product type when combined with LLM-generated and standards-based specs.
#
# =============================================================================
...
class SpecImportance(str, Enum):
    """Importance levels for specifications"""
    CRITICAL = "CRITICAL"      # Safety/compliance-critical
    REQUIRED = "REQUIRED"      # Necessary for operation
    IMPORTANT = "IMPORTANT"    # Adds significant value
    OPTIONAL = "OPTIONAL"      # Nice to have
    DERIVED = "DERIVED"        # Computed from other specs


@dataclass
class SpecificationDefinition:
    """Schema for a single specification"""
    key: str
    category: str
    description: str
    ...
    importance: SpecImportance = SpecImportance.IMPORTANT
    source_priority: int = 5


# =============================================================================
# PRESSURE TRANSMITTER TEMPLATE (65+ SPECS)
# =============================================================================
...
def get_template_for_product_type(product_type: str):
